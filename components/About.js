      ...
      <div className="flex flex-col w-full justify-between px-20 py-10 rounded-md ">
        ...
        <div className="flex flex-col justify-center w-full divide-zinc-700 divide-y divide-dotted">
          <div className="flex flex-wrap py-2 pr-2 pt-2">
            <a href="https://github.com/sudo-logic" target="_blank" rel="noreferrer">
              <img
            ...
            <a href="https://linkedin.com/in/ayush-mishra-srm" target="_blank" rel="noreferrer">
              <img
            ...
            <a href="https://instagram.com/_logeek_" target="_blank" rel="noreferrer">
              <img
